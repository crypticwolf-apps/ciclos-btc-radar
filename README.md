...
└─ components/sections/   incluye SourcesStatusSection ("Estado de fuentes")
```
...
de dev, capa de datos del front (hooks TanStack Query) y panel **«Estado de fuentes»**.
...
✅ **Gráfico de precio** con selector de rango (1D–Máx) y **USD/EUR**, badge de frescura
por tarjeta y estados de carga/error/«dato no disponible».
